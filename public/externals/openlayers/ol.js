...
(function(root, factory) {
  ...
  function tb(a, c, d, e) {
      for (var f, g = 0, h = a.length; g < h; ++g)
          if (f = a[g], f.listener === c && f.ig === d) return e && (f.deleteIndex = g), f
  }
  ...
  */
  ...
  function Gd(a, c, d, e, f, g, h, k, m, n, p) {
      ...
      for (var r = p ? p : [NaN, NaN], u = c + e; u < d;)
          if (Dd(a, u - e, u, e, h, k, r), q = Oa(h, k, r[0], r[1]), q < n) {
              n = q;
          ...
          a: {
              ...
              if (c != r) {
                  ...
                  var z = void 0,
                      B = void 0;
                  do
                      if (z = v * Math.round(q[c] / v), B = v * Math.round(q[c + 1] / v), c += u, c == r) {
                          w[h++] = z;
                          w[h++] = B;
                          break a
                      } while (z == A && B == D);
  ...
  l.Ze = function(a, c, d) {
      ...
      var k = a.ga(),
          ...
          r = -Infinity;
      a = a.ra();
      for (var u = 0, v = k.length; u < v; u += a) var w = k[u] * e - k[u + 1] * m,
          A = k[u] * m + k[u + 1] * e,
          n = Math.min(n, w),
          p = Math.min(p, A),
          q = Math.max(q, w),
              ...
              if (h = r[d].layer.ea())
                  if (p = x(h).toString(), n = h.da())
                      for (e = 0, f = n.length; e < f; e++)
                          if (k = n[e], m = x(k).toString(), !(m in u)) {
                              if (g = a.usedTiles[p]) {
                                  var A = h.eb(w);
                                  a: {
                                      q = k;
  ...
  function vi(a, c, d, e, f, g, h, k, m, n) {
      ...
      for (z = h; z >= r; --z)
          for (v = dg(d, g, z, v), w = d.$(z), A = v.ua; A <= v.wa; ++A)
              for (D = v.za; D <= v.Ba; ++D) h - z <= k ? (u = c.Lb(z, A, D, e, f), 0 == u.V() && (q[u.ja.toString()] = !0, u.gb() in a.g || a.f([u, p, hg(d, u.ja), w])), void 0 !== m && m.call(n, u)) : c.Tf(z, A, D, f)
  };
  ...
  function kk(a) {
      ...
      if (void 0 === c) this.b = document.createElement("CANVAS"), this.b.height = h, this.b.width = h, d = h = this.b.width, c = this.b.getContext("2d"), this.Ch(f, c, 0, 0), this.f ?
          this.i = this.b : (c = this.i = document.createElement("CANVAS"), c.height = f.size, c.width = f.size, c = c.getContext("2d"), this.Bh(f, c, 0, 0));
      else {
          h = Math.round(h);
  ...
  function kl(a, c, d, e, f, g, h, k, m, n, p) {
      ...
      var u = Pg(Math.round(d * Lc(r) / e), Math.round(d * Mc(r) / e)),
          v = d / e;
      m.forEach(function(a) {
      ...
      k.f.forEach(function(a) {
          ...
          a: {
              ...
              m = Array(k);
              for (n = k - 1; 0 <= n; n--)
                  for (m[n] = h[n][k] / h[n][n], Ta = n - 1; 0 <= Ta; Ta--) h[Ta][k] -= h[Ta][n] * m[n];h = m
          }
  ...
  function El(a, c, d) {
      if (4 == a.nodeType || 3 == a.nodeType) c ? d.push(String(a.nodeValue).replace(/(\r\n|\r|\n)/g, "")) : d.push(a.nodeValue);
          ...
          for (a = a.firstChild; a; a = a.nextSibling) El(a, c, d);
      return d
  }
          ...
          c.prototype = {
              ...
              $f: function(a, c, e, f) {
                  ...
                  for (q(a, c, e, h, this.Re); c <= e; c += h)
                      for (n = Math.min(c + h - 1, e), q(a, c, n, g, this.Se), m = c; m <= n; m += g) p = Math.min(m + g - 1, n), k.children.push(this.$f(a, m, p, f - 1));
                  d(k, this.jb);
                  return k
              },
              cj: function(a, c, d, e) {
              ...
              bg: function(a, c, d) {
                  ...
                  d = d ? a.bbox : e(a);
                  var e = [],
                      g = this.cj(d, this.data, c, e);
                  g.children.push(a);
                  for (f(g.bbox, d); 0 <= c;)
                      if (e[c].children.length > this.Pe) this.lj(e, c), c--;
                      else break;
                  this.$i(d, e, c)
              },
              lj: function(a, c) {
      ...
      function c(a) {
          ...
          if (c) {
              if (c) {
                  e = !1;
                  if (Array.isArray(c))
                      for (var f = 0, g = c.length; f < g; ++f) e = el(r, a, c[f], dl(n, p), this.H, this) || e;
                  else e = el(r, a, c, dl(n, p), this.H, this) || e;
                  a = e
              } else a = !1;
              this.i = this.i || a
          }
  ...
  Am.prototype.c = function(a, c, d) {
      ...
      for (J = c.length; B < J; ++B)
          if (ba = c[B], K = ba.c, Ja = A.Da(ba.ja, this.U),
              D = ba.ja[0], Ta = Qb(A.Ya(D), this.N), I = "tile-pixels" == ba.g.g, M = A.$(D), oa = M / u, z = M / m, M = Math.round(e * n[0] / 2), Y = Math.round(e * n[1] / 2), Aa = Ta[0] * e * z, z *= Ta[1] * e, Ta = Ta[0] * e, Aa < Ta / 4 || Aa > 4 * Ta) I ? (Ja = Ic(Ja), oa = ki(this.j, M, Y, p * oa, p * oa, g, (Ja[0] - h[0]) / oa, (h[1] - Ja[1]) / oa)) : oa = v, K.xd.a(q, e, oa, g, f);
          else {
              D = pg(r, D, e, k);
  ...
  Am.prototype.o = function(a, c) {
      ...
      for (A = n.ua; A <=
          n.wa; ++A)
          for (D = n.za; D <= n.Ba; ++D) k = e.Lb(p, A, D, g, f), w = k.V(), 2 == w || 4 == w || 3 == w && !r ? h[p][k.ja.toString()] = k : (w = cg(m, k.ja, q, v, u), w || (k = eg(m, k.ja, v, u)) && q(p + 1, k));
      this.i = !1;
      e = Object.keys(h).map(Number);
      e.sort(Va);
      for (var m = [], z, p = 0, n = e.length; p < n; ++p)
          for (z in k = e[p], q = h[k], q) k = q[z], 2 == k.V() && (m.push(k), Bm(this, k, d, g, f));
      this.A = m;
      return !0
  };
      ...
      function c(a) {
          ...
          if (c) {
              if (c) {
                  e = !1;
                  if (Array.isArray(c))
                      for (var f = 0, g = c.length; f < g; ++f) e = el(p, a, c[f], dl(m, n), this.ph, this) || e;
                  else e = el(p, a, c, dl(m, n), this.ph, this) || e;
                  a = e
              } else a = !1;
              this.f = this.f || a
          }
  ...
  Km.prototype.Te = function(a) {
      if (a instanceof Wj) a = new Fm(a);
      else if (a instanceof Xj) a = new Gm(a);
      else if (a instanceof G) a = new Im(a);
      else return null;
      return a
  };
  ...
  function gn(a, c, d, e, f, g, h, k, m, n, p) {
      ...
      q.uniform1f(r.i, h);
      var v;
      if (void 0 === m) hn(a, q, c, k, a.oa, a.U);
      else {
          if (n) a: {
              f = c.g ? 5125 : 5123;c = c.g ? 4 : 2;g = a.g.length - 1;
              for (h = a.j.length - 1; 0 <= h; --h)
                  for (q.bindTexture(3553, a.j[h]), n = 0 < h ? a.i[h - 1] : 0, u = a.i[h]; 0 <= g && a.g[g] >= n;) {
                      v = a.g[g];
                      d = a.s[g];
                      e = x(d).toString();
  ...
  function nn(a, c, d, e, f, g, h, k, m, n) {
      ...
      for (q = Hk.length - 1; 0 <= q; --q)
          if (r = a.g[Hk[q]], void 0 !== r && (r = gn(r, c, d, e, f, p, g, h, k, m, n))) return r
  }
      ...
      function e(a) {
          ...
          if (c) {
              if (c) {
                  d = !1;
                  if (Array.isArray(c))
                      for (var e = 0, g = c.length; e < g; ++e) d = el(r, a, c[e], dl(n, p), this.rh, this) || d;
                  else d = el(r, a, c, dl(n, p), this.rh, this) || d;
                  a = d
              } else a = !1;
              this.l = this.l || a
          }
  ...
  function En(a, c, d, e) {
      var f = a.f,
          g = c.gb();
      if (Rf(a.a, g)) a = a.a.get(g), f.bindTexture(3553, a.qb), 9729 != a.Rg && (f.texParameteri(3553, 10240, 9729), a.Rg = 9729), 9729 != a.Tg && (f.texParameteri(3553, 10240, 9729), a.Tg = 9729);
      else {
  ...
  l.yj = function(a, c) {
      for (var d = this.f, e; 1024 < this.a.tc() - this.j;) {
          ...
          else if (+this.a.b.be == c.index) break;
          else --this.j;
          this.a.pop()
      }
  };
  ...
  function Mn(a) {
      ...
      if (void 0 !== c && c.f && void 0 !== d) {
          var d = c.Ga(d),
              ...
              h = f[0],
              f = f[1];
          if ("bottom-right" == g || "center-right" == g || "top-right" == g) "" !== a.a.ce && (a.a.ce = c.left = ""), h = Math.round(e[0] - d[0] - h) + "px", a.a.Ae != h && (a.a.Ae = c.right = h);
          else {
          ...
          if ("bottom-left" == g || "bottom-center" == g || "bottom-right" ==
              g) "" !== a.a.Be && (a.a.Be = c.top = ""), d = Math.round(e[1] - d[1] - f) + "px", a.a.Ld != d && (a.a.Ld = c.bottom = d);
          else {
  ...
  function Mo(a) {
      ...
      this.b["http://www.opengis.net/gml"] = {
          featureMember: Kl(Mo.prototype.ud),
          featureMembers: Kl(Mo.prototype.ud)
      };
      Jo.call(this)
  }
  y(Mo, Jo);
  ...
  l.Ni = {
      "http://www.opengis.net/gml": {
          pointMember: Jl(Mo.prototype.Hh),
          pointMembers: Jl(Mo.prototype.Hh)
      }
  };
  l.Mi = {
      "http://www.opengis.net/gml": {
  ...
  l.Oi = {
      "http://www.opengis.net/gml": {
          polygonMember: Jl(Mo.prototype.Ih),
          polygonMembers: Jl(Mo.prototype.Ih)
      }
  };
  l.Ri = {
      "http://www.opengis.net/gml": {
          Point: Jl(Mo.prototype.ue)
      }
  };
  l.Ki = {
      "http://www.opengis.net/gml": {
          LineString: Jl(Mo.prototype.we)
      }
  };
  l.Si = {
      "http://www.opengis.net/gml": {
          Polygon: Jl(Mo.prototype.xe)
      }
  };
  l.Fd = {
      "http://www.opengis.net/gml": {
          LinearRing: Kl(Mo.prototype.co)
      }
  };
  l.gc = function(a, c) {
      var d = {
  ...
  l.Ed = {
      "http://www.opengis.net/gml": {
          coordinates: Kl(Zo.prototype.Lh)
      }
  };
  l.Ie = {
      "http://www.opengis.net/gml": {
          innerBoundaryIs: Zo.prototype.cl,
          outerBoundaryIs: Zo.prototype.Jn
      }
  };
  l.Gi = {
      "http://www.opengis.net/gml": {
          coordinates: Jl(Zo.prototype.Lh)
      }
  };
  l.Xf = {
      "http://www.opengis.net/gml": {
  ...
  l.Ed = {
      "http://www.opengis.net/gml": {
          pos: Kl($o.prototype.eo),
          posList: Kl($o.prototype.If)
      }
  };
  l.Ie = {
      "http://www.opengis.net/gml": {
          interior: $o.prototype.el,
          exterior: $o.prototype.zj
      }
  };
  l.Xf = {
      "http://www.opengis.net/gml": {
  ...
  l.Li = {
      "http://www.opengis.net/gml": {
          curveMember: Jl($o.prototype.qg),
          curveMembers: Jl($o.prototype.qg)
      }
  };
  l.Pi = {
      "http://www.opengis.net/gml": {
          surfaceMember: Jl($o.prototype.ni),
          surfaceMembers: Jl($o.prototype.ni)
      }
  };
  l.Hi = {
      "http://www.opengis.net/gml": {
          LineString: Jl(Mo.prototype.we),
          Curve: Jl($o.prototype.Jh)
      }
  };
  l.Wi = {
      "http://www.opengis.net/gml": {
          Polygon: Jl(Mo.prototype.xe),
          Surface: Jl($o.prototype.Uh)
      }
  };
  l.Xi = {
      "http://www.opengis.net/gml": {
          patches: Kl($o.prototype.mo)
      }
  };
  l.Ii = {
      "http://www.opengis.net/gml": {
          segments: Kl($o.prototype.oo)
      }
  };
  l.Ji = {
      "http://www.opengis.net/gml": {
          lowerCorner: Jl($o.prototype.If),
          upperCorner: Jl($o.prototype.If)
      }
  };
  l.Qi = {
      "http://www.opengis.net/gml": {
          PolygonPatch: Kl($o.prototype.no)
      }
  };
  l.Vi = {
      "http://www.opengis.net/gml": {
          LineStringSegment: Kl($o.prototype.ho)
      }
  };
  ...
  l.$o = function(a, c, d) {
      ...
      Sl({
          node: a
      }, bp, Pl, [c[0] + " " + c[1], c[2] + " " + c[3]], d, ["lowerCorner", "upperCorner"], this)
  };
  l.zi = function(a, c, d) {
      var e = d[d.length - 1].srsName;
      e && a.setAttribute("srsName", e);
  ...
  l.ap = function(a, c, d) {
      ...
      Sl({
          node: a,
          srsName: e
      }, ep, Nl("pointMember"), c, d, void 0, this)
  };
  l.Ai = function(a, c, d) {
      var e = d[d.length - 1],
          f = e.srsName,
  ...
  var dp = {
      ...
      cp = {
          "http://www.opengis.net/gml": {
              exterior: N($o.prototype.Di),
              interior: N($o.prototype.Di)
          }
      },
      gp = {
          "http://www.opengis.net/gml": {
  ...
  $o.prototype.s = function(a, c) {
      c = ho(this, c);
      var d = Cl("http://www.opengis.net/gml", "geom"),
          e = {
              node: d,
  ...
  function Ap(a, c, d) {
      ...
      Sl({
          node: a
      }, Bp, Pl, [c.linkText, c.linkType], d, Cp)
  }
  ...
  var Cp = ["text", "type"],
      ...
      Gp = O(jp, "name cmt desc src link number type rtept".split(" ")),
      Hp = O(jp, {
          name: N(Wo),
          cmt: N(Wo),
          desc: N(Wo),
      ...
      Ip = O(jp, "name cmt desc src link number type trkseg".split(" ")),
      Lp = O(jp, {
          name: N(Wo),
          cmt: N(Wo),
          desc: N(Wo),
      ...
      Ep = O(jp, "ele time magvar geoidheight name cmt desc src link sym type fix sat hdop vdop pdop ageofdgpsdata dgpsid".split(" ")),
      Fp = O(jp, {
          ele: N(Xo),
          time: N(function(a, c) {
  ...
  y(Rp, Pp);
  var Sp = /^B(\d{2})(\d{2})(\d{2})(\d{2})(\d{5})([NS])(\d{3})(\d{5})([EW])([AV])(\d{5})(\d{5})/,
      Tp = /^H.([A-Z]{3}).*?:(.*)/,
      Up = /^HFDTE(\d{2})(\d{2})(\d{2})/,
      Vp = /\r\n|\r|\n/;
  Rp.prototype.td = function(a, c) {
      ...
      for (p = e.length; n < p; ++n) {
          ...
          if ("B" == q.charAt(0)) {
              ...
              if (r =
                  Up.exec(q)) m = parseInt(r[1], 10), k = parseInt(r[2], 10) - 1, h = 2E3 + parseInt(r[3], 10);
              else if (r = Tp.exec(q)) f[r[1]] = r[2].trim(), Up.exec(q)
      }
  ...
  function Wp(a, c) {
      ...
      if (1 < d) {
          ...
          var f;
          if (a instanceof Wp) f = a.O(), e = a.wc();
          else {
              var d = [],
                  g = 0;
              for (f in a) d[g++] = f;
  ...
  function bq(a, c, d) {
      if ("array" == ea(c))
          for (var e = 0; e < c.length; e++) bq(a, String(c[e]), d);
  ...
  l.wc = function(a) {
      tq(this);
      var c = [];
      if (ga(a)) vq(this, a) && (c = Ge(c, this.b.get(uq(this, a))));
      else {
          a = this.b.wc();
  ...
  y(xq, Jo);
  var zq = ["http://www.google.com/kml/ext/2.2"],
      Aq = [null, "http://earth.google.com/kml/2.0", "http://earth.google.com/kml/2.1", "http://earth.google.com/kml/2.2", "http://www.opengis.net/kml/2.2"],
      Bq = [255, 255, 255, 1],
      Cq = new ck({
          color: Bq
      }),
  ...
  function dr(a, c) {
      var d = P({}, er, a, c);
      if (!d) return null;
      var e = "fillStyle" in d ? d.fillStyle : Cq,
          f = d.fill;
      void 0 === f || f || (e = null);
      var f = "imageStyle" in d ? d.imageStyle : Fq,
          g = "textStyle" in d ? d.textStyle : Hq,
          h = "strokeStyle" in d ? d.strokeStyle : Gq,
          d = d.outline;
      void 0 === d || d || (h = null);
      return [new lk({
          fill: e,
  ...
  var hr = O(Aq, {
      ...
      er = O(Aq, {
          ...
          LabelStyle: function(a, c) {
              var d = P({}, nr, a,
                  c);
              d && (c[c.length - 1].textStyle = new wq({
                  fill: new ck({
  ...
  function xr(a, c) {
      ...
      for (d = c.firstElementChild; d; d = d.nextElementSibling)
          if (Wa(Aq, d.namespaceURI) && "name" == d.localName) return U(d);
      for (d = c.firstElementChild; d; d = d.nextElementSibling) {
          var e = d.localName;
  ...
  function zr(a, c) {
      var d, e = [];
      for (d = c.firstElementChild; d; d = d.nextElementSibling)
          if (Wa(Aq, d.namespaceURI) && "NetworkLink" == d.localName) {
              var f = P({}, rr, d, []);
              e.push(f)
  ...
  var Qr = O(Aq, ["Document", "Placemark"]),
      Tr = O(Aq, {
          Document: N(function(a, c, d) {
              Sl({
                  node: a
              }, Rr, Sr, c, d, void 0, this)
          }),
          Placemark: N(Er)
      }),
      Rr = O(Aq, {
      ...
      Xr = O(Aq, ["scale", "heading", "Icon", "hotSpot"]),
      Zr = O(Aq, {
          Icon: N(function(a,
              c, d) {
              a = {
              ...
              var e = Vr[d[d.length - 1].node.namespaceURI],
                  f = Ql(c, e);
              Sl(a, Wr, Pl, f, d, e);
              e = Vr[zq[0]];
              f = Ql(c, e);
      ...
      Mr = O(Aq, {
          outerBoundaryIs: N(Br),
          innerBoundaryIs: N(Br)
      }),
      js = O(Aq, {
          color: N(Ar)
      }),
      hs = O(Aq, ["IconStyle", "LabelStyle", "LineStyle", "PolyStyle"]),
      is = O(Aq, {
  ...
  var ks = Nl("color"),
      Kr = Nl("coordinates"),
      Nr = Nl("innerBoundaryIs"),
      es = Nl("Point"),
      fs = Nl("LineString"),
      Dr = Nl("LinearRing"),
      gs = Nl("Polygon"),
      Or = Nl("outerBoundaryIs");
              ...
              3: [function(a, c) {
                  ...
                  g.prototype.Qg = function() {
                      ...
                      for (var c = a.Ca() +
                          ...
                          if (f || (f = a.Ca(), e = f & 7, f = f >> 3), f--, 1 === e || 2 === e) g += a.wd(), h += a.wd(), 1 === e && (w && v.push(w), w = []), w.push(new k(g, h));
                  ...
                  g.prototype.bbox = function() {
                      ...
                      for (var c = a.Ca() + a.ca, e = 1, f = 0, g = 0, h = 0, k = Infinity, w = -Infinity, A = Infinity, D = -Infinity; a.ca < c;)
                          if (f || (f = a.Ca(), e = f & 7, f = f >> 3), f--, 1 === e || 2 === e) g += a.wd(), h += a.wd(), g < k && (k = g), g > w && (w = g), h < A && (A = h), h > D &&
                              (D = h);
  ...
  var xs = [null, "http://www.opengis.net/ows/1.1"],
      ws = O(xs, {
      ...
      if ("Topology" == a.type) {
          ...
          if (d) {
              ...
              for (m = g.length; k < m; ++k)
                  for (var n = g[k], p = d, q = h, r = 0, u = 0, v = void 0, w = void 0, A = void 0, w = 0, A = n.length; w < A; ++w) v = n[w], r += v[0], u += v[1], v[0] = r, v[1] = u, Xs(v, p, q)
          }
          d = [];
          h = ob(a.objects);
          k = 0;
  ...
  var Ws = {
      ...
      MultiPoint: function(a, c, d) {
          ...
          var e, f;
          if (c && d)
              for (e = 0, f = a.length; e < f; ++e) Xs(a[e], c, d);
          return new po(a)
      },
  ...
  function at(a, c) {
      for (var d = c.firstChild; d; d = d.nextSibling)
          if (1 == d.nodeType) return bt(a, d)
  }
  var ct = {
      "http://www.opengis.net/gml": {
          boundedBy: L(Mo.prototype.ve, "bounds")
      }
  };

  function bt(a, c) {
      var d = {},
          e = Uo(c.getAttribute("numberOfFeatures"));
  ...
  function ht(a, c) {
      var d = Cl("http://www.opengis.net/ogc", "Filter"),
          e = Cl("http://www.opengis.net/ogc", "FeatureId");
      d.appendChild(e);
  ...
  var it = {
          "http://www.opengis.net/wfs": {
              Insert: N(function(a, c, d) {
                  var e = d[d.length - 1],
                      e = Cl(e.featureNS, e.featureType);
                  a.appendChild(e);
  ...
  Ys.prototype.U = function(a, c, d, e) {
      var f = [],
          g = Cl("http://www.opengis.net/wfs", "Transaction");
  ...
  Ys.prototype.Lf = function(a) {
      for (a = a.firstChild; a; a = a.nextSibling)
          if (1 == a.nodeType) return this.ye(a);
      return null
  };
  ...
  var Kt = [null, "http://www.opengis.net/wms"],
      Ct = O(Kt, {
      ...
      Pt = O(Kt, {
          ...
          BoundingBox: Ll(function(a) {
              var c = [So(a.getAttribute("minx")), So(a.getAttribute("miny")), So(a.getAttribute("maxx")), So(a.getAttribute("maxy"))],
                  d = [So(a.getAttribute("resx")), So(a.getAttribute("resy"))];
              return {
          ...
          Identifier: Ll(U),
          MetadataURL: Ll(function(a, c) {
              var d = Dt(a, c);
              if (d) return d.type = a.getAttribute("type"),
                  d
          }),
          DataURL: Ll(Dt),
          FeatureListURL: Ll(Dt),
          Style: Ll(function(a, c) {
              return P({}, Vt, a, c)
          }),
          MinScaleDenominator: L(Ro),
          MaxScaleDenominator: L(Ro),
      ...
      Tt = O(Kt, {
          ...
          eastBoundLongitude: L(Ro),
          southBoundLatitude: L(Ro),
          northBoundLatitude: L(Ro)
      }),
      Nt = O(Kt, {
          GetCapabilities: L(Ft),
          GetMap: L(Ft),
          GetFeatureInfo: L(Ft)
      }),
      Gt = O(Kt, {
  ...
  var bu = [null, "http://www.opengis.net/wmts/1.0"],
      cu = [null, "http://www.opengis.net/ows/1.1"],
      $t = O(bu, {
      ...
      eu = O(bu, {
          ...
          Format: Ll(U),
          TileMatrixSetLink: Ll(function(a, c) {
              return P({}, hu, a, c)
          }),
  ...
  function Uu(a, c) {
      var d = c.coordinate;
      a.s = d;
      a.c === Pu ? a.a = d.slice() : a.c === Ou ? (a.a = [
          [d.slice(), d.slice()]
      ], a.T = a.a[0]) : (a.a = [d.slice(), d.slice()], a.c === Vu && (a.T = a.a));
  ...
  function Su(a, c) {
      var d = c.coordinate,
          e = a.l.W(),
          f, g;
      if (a.c === Qu) a.s = d.slice(), g = a.a, g.push(d.slice()), f = g.length > a.ta, a.H(g, e);
      else if (a.c === Ou) {
          g = a.a[0];
          g.push(d.slice());
  ...
  function Dv(a, c, d, e, f, g, h, k, m, n, p) {
      ...
      else if ((k = a.G()) && (f ? f = Pc(f, k) : f = k), e = e.$(this.s[0]), e = il(a, d, Nc(g), e), !isFinite(e) || 0 >= e) this.state = 4;
      else if (this.A = new ll(a, d, g, f, e * (void 0 !== n ? n : .5)), 0 === this.A.f.length) this.state = 4;
      else if (this.o = ig(c, e), d = nl(this.A), f && (a.a ? (d[1] = La(d[1],
  ...
  function Qv(a) {
      var c = a.imageExtent,
          ...
          e = void 0 !== a.imageLoadFunction ? a.imageLoadFunction : wl;
      ql.call(this, {
          attributions: a.attributions,
          logo: a.logo,
          ...
          return function e(a, c, h) {
              ...
              2: [function(a, c) {
                  ...
                  function m(a) {
                      ...
                      var e = [];
                      if (c)
                          for (var f = 0; f < c; ++f) e[f] = h(a, this.dg.bind(this, f));
                      else e[0] = k(a, this.dg.bind(this, 0));
                      this.Kd = e;
                      this.Xc = [];
  ...
  function aw(a) {
      for (var c = a.length, d = Array(c), e = 0; e < c; ++e) {
          ...
          g instanceof ng ? (g = new Xj({
              source: g
          }), h = new qm(g)) : g instanceof ql && (g = new Wj({
              source: g
          }), h = new pm(g));
          d[f] = h
      }
  ...
  function ow(a) {
      ...
      if (a.jsonp) Cv(a.url, this.th.bind(this), this.$d.bind(this));
      else {
